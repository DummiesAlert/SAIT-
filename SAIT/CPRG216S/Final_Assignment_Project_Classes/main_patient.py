...
def readPatientsFile():
    patient_list=[]
    P_file= open(r"C:\SAIT\CPRG216S\Final_Assignment_Project_Classes\Project Data\patients.txt")
...
def editPatientInfo():
    ...
    f=open(r"C:\SAIT\CPRG216S\Final_Assignment_Project_Classes\Project Data\patients.txt","a")
    ...
    list = object_patient + name + diagnosis + gender + age 
    f.write("\n" + list)
    f.close()
    return list
...
def writePatientsListToFile(patient_list):
    P_file=open(r"C:\SAIT\CPRG216S\Final_Assignment_Project_Classes\Project Data\patients.txt","a")
